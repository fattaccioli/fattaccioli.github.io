...
layout: page
title: Teaching
description: "Teaching activities of Jacques Fattaccioli in chemistry, microfluidics, image analysis, and microscopy at Bachelor, Master, and professional levels."
permalink: /teaching/
---
...
🔗 [Full program details — microfluidics-master.fr](https://microfluidics-master.fr/)
...
- Applications in chemical analysis, cell biology, and diagnostics
Content and emphasis are adapted depending on participant background and application domain.
...
For enquiries or custom program design, feel free to [get in touch](mailto:jacques.fattaccioli@ens.psl.eu).